...
//latest IG post
$result = get_CURL('https://api.instagram.com/v1/users/self/media/recent/?access_token=1820664604.1731dfd.fb778f67629f404c827d8efa41347aec&count=1');

class C_Photos {
    public $content_photos;
    public $content_tags;

    public function  __construct($_photos, $_tags) {
        $this->content_photos   = $_photos;
        $this->content_tags     = $_tags;
    }
}
foreach ($result['data'] as $photo) {
  $_portofolio[] = new C_Photos($photo['images']['standard_resolution']['url'], $photo['tags'][1]);
}
?>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 col-md-6">
            <div class="about-img">
              <img src="img/about-img-studio.jpg" alt="">
            </div>
          </div>
          ...
          <div class="col-lg-7 col-md-6">
            <div class="about-content">
              <h2>About Us</h2>
              <h3><span>Three Studio</span> - Surabaya Professional Photography Service</h3>
    ...
    <section id="services" class="section-bg">
      <div class="container">
        ...
        <header class="section-header">
          <h3>Services</h3>
          <p>Berikut adalah servis yang tersedia untuk saat ini</p>
        </header>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-duration="1.4s">
            <div class="box">
              <div class="icon" style="background: #fceef3;"><i class="icon ion-ios-pizza-outline" style="color: #ff689b;"></i></div>
          ...
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-duration="1.4s">
            <div class="box">
              <div class="icon" style="background: #fff0da;"><i class="icon ion-ios-pizza-outline" style="color: #e98e06;"></i></div>
          ...
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="box">
              <div class="icon" style="background: #e6fdfc;"><i class="ion-ios-book" style="color: #3fcdc7;"></i></div>
    ...
    <section id="portfolio" class="section-bg">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-bye2017">bye2017</li>
        ...
        <div class="row portfolio-container">
            <?php foreach ($_portofolio as $key=>$photo) : ?>
                <div class="col-lg-4 col-md-6 portfolio-item filter-<?php echo $photo->content_tags; ?>">
                    <div class="portfolio-wrap">
                        <img src="<?php echo $photo->content_photos; ?>" class="img-fluid alt=">
                        <div class="portfolio-info">
                            <h4><a href="#"><?php echo $photo->content_tags; ?></a></h4>
                            <p><?php echo $photo->content_tags; ?></p>
                            <div>
                                <a href="img/portfolio/fas1.jpg" data-lightbox="portfolio" data-title="App 1" class="link-preview" title="Preview"><i class="ion ion-eye"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="img/portfolio/fas1.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app" data-wow-delay="0.2s">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Fashion</p>
                <div>
                  <a href="img/portfolio/fas2.jpg" class="link-preview" data-lightbox="portfolio" data-title="App 2" title="Preview"><i class="ion ion-eye"></i></a>
                  <a href="#" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app" data-wow-delay="0.2s">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Fashion</p>
                <div>
                  <a href="img/portfolio/fas3.jpg" class="link-preview" data-lightbox="portfolio" data-title="App 3" title="Preview"><i class="ion ion-eye"></i></a>
                  <a href="#" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
                </div>
              </div>
            </div>
